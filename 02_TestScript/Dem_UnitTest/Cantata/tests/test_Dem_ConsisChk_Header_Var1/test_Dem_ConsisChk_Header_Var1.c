...
/*****************************************************************************/
/*
 *    Filename: test_Dem_ConsisChk_Header_Var1.c
 *    Author: EUD1HC
 *    Generated on: 03-Aug-2018 13:53:09
...
void run_tests();
void test_Dem_StatusByteConsistencyCheck_RestoreTestFail_Confirm_Pending(int);
void test_Dem_StatusByteConsistencyCheck_DEM_EVMEM_STSMASK_TESTFAILED_SLC(int);
void test_Dem_StatusByteConsistencyCheck_DEM_EVMEM_STSMASK_DELETED(int);
void test_Dem_StatusByteConsistencyCheck_FALSE(int);
void test_Dem_StatusByteConsistencyCheck_NothingToDo(int);
...
int main()
{
    ...
    OPEN_LOG("test_Dem_ConsisChk_Header_Var1.ctr", false, 100);
...
void run_tests()
{
    test_Dem_StatusByteConsistencyCheck_RestoreTestFail_Confirm_Pending(1);
    test_Dem_StatusByteConsistencyCheck_DEM_EVMEM_STSMASK_TESTFAILED_SLC(1);
    test_Dem_StatusByteConsistencyCheck_DEM_EVMEM_STSMASK_DELETED(1);
    test_Dem_StatusByteConsistencyCheck_FALSE(1);
    test_Dem_StatusByteConsistencyCheck_NothingToDo(1);

    rule_set("*", "*");
    EXPORT_COVERAGE("test_Dem_ConsisChk_Header_Var1.cov", cppca_export_replace);
}
...
void test_Dem_StatusByteConsistencyCheck_RestoreTestFail_Confirm_Pending(int doIt){
if (doIt) {
    /* Compilation flag
     * Define DEM_CONSISCHK_H;
     * Define DEM_CFG_TFSLC_RESET_AFTER_AGING_AND_DISPLACEMENT as TRUE;
     */
    ...
    uint16_least LocId = 0x045;
    uint16_least Status = 0x4C;
    ...
    START_TEST("test_Dem_StatusByteConsistencyCheck_RestoreTestFail_Confirm_Pending",
               " Check whether: "
               " - Dem_EvtSt_SetTestFailed() function is invoked "
               " - Dem_EvtSt_SetConfirmedDTC() and Dem_EvtSt_SetPendingDTC() functions are invoked "
               " In case :"
               " - The returned value of Dem_EvMemIsOriginPrimary() function is TRUE (line 20) "
               " - The returned value of Dem_LibGetParamBool() function is TRUE (line 25) "
               " - Confirmed bit is set in the status (line 41) "
               " - Pending DTC bit is set in the status (line 45) ");

        /* Expected Call Sequence  */
        EXPECTED_CALLS("Dem_EvMemIsOriginPrimary#TC_04_01;"
                       "Dem_EvMemGetEventMemEventId#TC_04_01;"
                       "Dem_LibGetParamBool#TC_04_01;"
                       "Dem_EvtSt_SetTestFailed#TC_04_01;"
                       "Dem_EvtSt_SetTestFailedSLC#TC_04_01;"
                       "Dem_EvtSt_SetTestCompleteSLC#TC_04_01;"
                       "Dem_EvtSt_SetConfirmedDTC#TC_04_01;"
                       "Dem_EvtSt_SetPendingDTC#TC_04_01;");

            /* Call SUT */
            ACCESS_FUNCTION(Dem_ConsisChk, Dem_StatusByteConsistencyCheck)(LocId, Status);
            ...
            check_global_data();
            /* GUID
             * - {24E40056-FE6D-42e2-A92A-7B01B9355B0D};
             * - {FF245C24-7608-4c8f-9B78-0C8BE4C20374};
             * - {C7331026-AF5E-4f59-BBD6-32DA211D3FCE};
             * - {D33E88E5-2E51-48b2-ADF4-D201A0ED1A69};
             * - {4D627B75-6601-4dbf-8C13-507480BF550F};
             * - {02F7ADD2-2EB0-495a-9810-DB5D35F148FB};
             */
        END_CALLS();
    END_TEST();
}}

void test_Dem_StatusByteConsistencyCheck_DEM_EVMEM_STSMASK_TESTFAILED_SLC(int doIt){
if (doIt) {
    /* Test Method - EP */
    /* Tester define */
    ...
    START_TEST("test_Dem_StatusByteConsistencyCheck_DEM_EVMEM_STSMASK_TESTFAILED_SLC",
               " Check whether: "
               " - Dem_EvtSt_SetTestFailed() function is invoked "
               " - Dem_EvtSt_SetConfirmedDTC() and Dem_EvtSt_SetPendingDTC() functions are not invoked "
               " In case :"
               " - The returned value of Dem_EvMemIsOriginPrimary() function is TRUE (line 20) "
               " - The returned value of Dem_LibGetParamBool() function is TRUE (line 25) "
               " - Confirmed bit is not set in the status (line 41) "
               " - Pending DTC bit is not set in the status (line 45) ");
        ...
        EXPECTED_CALLS("Dem_EvMemIsOriginPrimary#TC_04_01;"
            ...
            /* Test case checks */
            /* Expected Result - Dem_EvtSt_SetConfirmedDTC() and Dem_EvtSt_SetPendingDTC() functions are not invoked */
            /* Checks on global data */
            check_global_data();
            /* GUID
             * - {24E40056-FE6D-42e2-A92A-7B01B9355B0D};
...
void test_Dem_StatusByteConsistencyCheck_DEM_EVMEM_STSMASK_DELETED(int doIt){
if (doIt) {
    /* Test Method - EP */
    /* Tester define */
    ...
    /* Test case data declarations */
    uint16_least LocId = 0x045;
    uint16_least Status = DEM_EVMEM_STSMASK_DELETED;
    ...
    START_TEST("test_Dem_StatusByteConsistencyCheck_DEM_EVMEM_STSMASK_DELETED",
               " Check whether: "
               " - Dem_EvtSt_SetTestFailed() function is invoked "
               " - Dem_EvtSt_SetTestFailedSLC() and Dem_EvtSt_SetTestCompleteSLC() function is not invoked "
               " In case :"
               " - The returned value of Dem_EvMemIsOriginPrimary() function is TRUE (line 20) "
               " - The returned value of Dem_LibGetParamBool() function is TRUE (line 25) "
               " - The status is not set to DEM_EVMEM_STSMASK_PENDING, DEM_EVMEM_STSMASK_CONFIRMED and DEM_EVMEM_STSMASK_TESTFAILED_SLC (line 33) ");
...
void test_Dem_StatusByteConsistencyCheck_FALSE(int doIt){
if (doIt) {
    /* Test Method - EP */
    ...
    START_TEST("test_Dem_StatusByteConsistencyCheck_FALSE",
               " Check whether Dem_EvtSt_SetTestFailed() function is not invoked "
               " In case :"
               " - The returned value of Dem_EvMemIsOriginPrimary() function is TRUE (line 20) "
               " - The returned value of Dem_LibGetParamBool() function is FALSE (line 25) ");

        /* Expected Call Sequence  */
        EXPECTED_CALLS("Dem_EvMemIsOriginPrimary#TC_04_01;"
                       "Dem_EvMemGetEventMemEventId#TC_04_01;"
                       "Dem_LibGetParamBool#TC_04_02;");

            /* Call SUT */
            ACCESS_FUNCTION(Dem_ConsisChk, Dem_StatusByteConsistencyCheck)(LocId, Status);

            /* Test case checks */
            /* Expected Result - Dem_EvtSt_SetTestFailed() function is not invoked */
            /* Checks on global data */
            check_global_data();
            /* GUID
             * - {02F7ADD2-2EB0-495a-9810-DB5D35F148FB};
...
void test_Dem_StatusByteConsistencyCheck_NothingToDo(int doIt){
if (doIt) {
    /* Test Method - EP */
    ...
    START_TEST("test_Dem_StatusByteConsistencyCheck_NothingToDo",
               " Check whether the function does nothing "
               " In case : The returned value of Dem_EvMemIsOriginPrimary() and Dem_EvMemIsOriginSecondary() functions are FALSE (line 20) ");

        /* Expected Call Sequence  */
        EXPECTED_CALLS("Dem_EvMemIsOriginPrimary#TC_04_02;"
                       "Dem_EvMemIsOriginSecondary#TC_04_02;");

            /* Call SUT */
            ACCESS_FUNCTION(Dem_ConsisChk, Dem_StatusByteConsistencyCheck)(LocId, Status);

            /* Test case checks */
            /* Expected Result - The function does nothing */
            /* Checks on global data */
            check_global_data();
            /* GUID - Not Applicable */
        END_CALLS();
