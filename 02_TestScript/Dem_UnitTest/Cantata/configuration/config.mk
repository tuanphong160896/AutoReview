...
# Generated from Cantata configuration section: H_W64_tb_mingw_comp_4.9.3_testversion_gcc_c99
...
#
DEFAULT_COMPILER_NAME := C:/toolbase/mingw/comp_4.9.3_testversion/bin/gcc
ifeq ($(USE_ESCAPED_SLASHES),1)
    ORIGINAL_DEFAULT_COMPILER_OPTS := -std=c99 -c %f -o %o
    ...
    DEFAULT_COMPILER_OPTS := -std=c99 -c %f -o %o
    DEFAULT_LINKER_OPTS := %f -o %o
    DEFINE_OPT := -D
    LIBRARY_OPT := -l%s
    INCLUDE_PATH_OPT := -I%s
endif
DEFAULT_LINKER_NAME := C:/toolbase/mingw/comp_4.9.3_testversion/bin/gcc
OBJ_FILE_EXTS := .o
