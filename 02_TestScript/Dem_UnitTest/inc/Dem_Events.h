...
{
  return ((uint8)(DEM_EVTPARAM_GETBITS(Dem_AllEventsParamFlags[EventId].configFlags, DEM_EVT_BP_PARAM_OPERATIONCYCLEID, DEM_EVT_BP_PARAM_OPERATIONCYCLEID_SIZE)));
}
...
{
   return ((uint8)(DEM_EVTPARAM_GETBITS(Dem_AllEventsParamFlags[EventId].configFlags, DEM_EVT_BP_PARAM_AGINGCYCLEID, DEM_EVT_BP_PARAM_AGINGCYCLEID_SIZE)));
}
...
{
   return ((uint8)(DEM_EVTPARAM_GETBITS(Dem_AllEventsParamFlags[EventId].configFlags, DEM_EVT_BP_PARAM_FAILURECYCLEID, DEM_EVT_BP_PARAM_FAILURECYCLEID_SIZE)));
}
