...
#define DEM_CFG_EVMEM_STATUS_BYTE_CONSISTENCY_PREFERENCE                      DEM_CFG_EVMEM_STATUS_BYTE_CONSISTENCY_PREFERENCE_EVENT_MEMORY
...
#define DEM_CFG_EVMEM_TRIGGER_ON_FDC_SUPPORTED               TRUE
...
#define DEM_CFG_IMMEDIATE_NV_STORAGE_LIMIT                   100

/* Primary Memory */
#define DEM_CFG_MAX_NUMBER_EVENT_ENTRY_PRIMARY               3u

/* TODO: User defined memory has to be considered */
/* Secondary Memory */
#define DEM_CFG_MAX_NUMBER_EVENT_ENTRY_SECONDARY             2u

#define DEM_DTC_ORIGIN_USERDEFINED_MEMORY                    0x10u

/* Mirror Memory */
#define DEM_CFG_MAX_NUMBER_EVENT_ENTRY_MIRROR                7u
...
/* Support of Failure Counter: 2 Failure Cycle Counter(s) Threshold larger than 1 */
