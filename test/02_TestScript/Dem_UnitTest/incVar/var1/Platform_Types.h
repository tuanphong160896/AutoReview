...
/*-------- Boolean Data Type--------- */
/* TRACE[SWS_Platform_00026]:This standard AUTOSAR type shall only be used together
with the definitions TRUE and FALSE. */
/* Deviation Diag */
#ifndef __cplusplus
/* MR12 DIR 1.1 VIOLATION: Required for compilation of c++ ? / legacy from old diag versions...  */
...
/* Deviation Diag */
/* Dummy-function to prevent naming of parameters "index"
 * Declaration of "index" and inclusion of "string.h" causes MISRA warnings
 * Creates MISRA-warnings : This declaration of 'index' hides a more global declaration. */
