...
define COMPILE_CC_CMD
        ...
        @$(ECHO_DEBUG_CMD) "$(subst %DIR%,$(patsubst %$(word $(words $(subst /, ,$@)),$(subst /, ,$@)),%,$@),$(subst %COP%,../../ipg.cop -F $(DYNAMIC_THIS_TEST)/ipg.cop,$(CANTPP_CMD))) --no_link $(DEFAULT_COMPILER_NAME) $(subst %f, "$<", $(subst %o, $@, $(subst %i, $(CANTATA_INSTALL_DIR), $(DEFAULT_COMPILER_OPTS)))) $(DEBUG_FLAGS) %DEFINES% %INCLUDES%"
        @$(subst %DIR%,$(patsubst %$(word $(words $(subst /, ,$@)),$(subst /, ,$@)),%,$@),$(subst %COP%,../../ipg.cop -F $(DYNAMIC_THIS_TEST)/ipg.cop,$(CANTPP_CMD))) --no_link $(DEFAULT_COMPILER_NAME) $(subst %f, "$<", $(subst %o, $@, $(subst %i, $(CANTATA_INSTALL_DIR), $(DEFAULT_COMPILER_OPTS)))) $(DEBUG_FLAGS) %DEFINES% %INCLUDES%
endef
...
define CC_LINK_CMD
        ...
        @$(ECHO_DEBUG_CMD) "$(subst %COP%,../../ipg.cop -F $(DYNAMIC_THIS_TEST)/ipg.cop,$(CANTPP_CMD)) $(DEFAULT_LINKER_NAME) $(subst %f, $(patsubst %ipg.cop,,$(patsubst %.mk,,$(patsubst %.cfg,,$^))), $(subst %o,$@,$(subst %i, $(CANTATA_INSTALL_DIR), $(DEFAULT_LINKER_OPTS)))) $(C_LINK_FINALOPTS) %EXTLIBS% %EXTOBJS%"
        @$(subst %COP%,../../ipg.cop -F $(DYNAMIC_THIS_TEST)/ipg.cop,$(CANTPP_CMD)) $(DEFAULT_LINKER_NAME) $(subst %f, $(patsubst %ipg.cop,,$(patsubst %.mk,,$(patsubst %.cfg,,$^))), $(subst %o,$@,$(subst %i, $(CANTATA_INSTALL_DIR), $(DEFAULT_LINKER_OPTS)))) $(C_LINK_FINALOPTS) %EXTLIBS% %EXTOBJS%
endef

define CXX_LINK_CMD
        @$(ECHO_CMD_MED) "Linking (C++) $@ ..."
        @$(ECHO_DEBUG_CMD) "$(subst %COP%,../../ipg.cop -F $(DYNAMIC_THIS_TEST)/ipg.cop,$(CANTPP_CMD)) $(DEFAULT_LINKER_NAME) $(subst %f, $(patsubst %ipg.cop,,$(patsubst %.mk,,$(patsubst %.cfg,,$^))), $(subst %o,$@,$(subst %i, $(CANTATA_INSTALL_DIR), $(DEFAULT_LINKER_OPTS)))) $(CPP_LINK_FINALOPTS) %EXTLIBS% %EXTOBJS%"
        @$(subst %COP%,../../ipg.cop -F $(DYNAMIC_THIS_TEST)/ipg.cop,$(CANTPP_CMD)) $(DEFAULT_LINKER_NAME) $(subst %f, $(patsubst %ipg.cop,,$(patsubst %.mk,,$(patsubst %.cfg,,$^))), $(subst %o,$@,$(subst %i, $(CANTATA_INSTALL_DIR), $(DEFAULT_LINKER_OPTS)))) $(CPP_LINK_FINALOPTS) %EXTLIBS% %EXTOBJS%
endef
